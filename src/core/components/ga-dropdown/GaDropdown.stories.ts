    ...
    template: `
      <div :style="{display:'flex',alignItems:'center',flexDirection:'column',gap:'16px'}">
        <ga-dropdown label='Click me to see options!' v-model='selected'>
          ...
          <ga-dropdown-item :value='1' label='Option 1: Basic Item' disabled />
          ...
          <ga-dropdown-item :value='6' label='Option 6: A Very Long and Selected Item for Testing, Very Long' />
